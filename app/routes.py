...
from app.metrics_service import (
    recalculate_metrics as _recalculate_metrics,
    compute_income_contributions as _compute_income_contributions,
)
...
# _recalculate_metrics is imported from app.metrics_service (see top-of-file imports)
...
# ACCOUNT_CATEGORIES, INVESTMENT_CATS, CASH_CATS, ALLOCATION_CLASSES imported from app.account_categories
...
# _compute_income_contributions is imported from app.metrics_service (see top-of-file imports)
